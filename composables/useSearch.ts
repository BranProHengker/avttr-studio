  ...
  },
  {
    ...
    tools: [
      ...
      },
      {
        id: 'spotify',
        title: 'Spotify Downloader',
        description: 'Fetch track metadata, Ultra HD album covers, and full MP3 audio streams.',
        category: 'music',
        icon: 'spotify',
        route: '/d/spotify',
        badge: 'Fast',
      ...
      },
      {
        id: 'soundcloud',
        title: 'SoundCloud Downloader',
        description: 'Download SoundCloud tracks, DJ mixes, podcasts, and Ultra HD artwork.',
        category: 'music',
        icon: 'soundcloud',
        route: '/d/soundcloud',
        badge: 'MP3',
