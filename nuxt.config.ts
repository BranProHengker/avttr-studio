  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { property: 'og:site_name', content: 'Avttr Studio' },
        ...
        { property: 'og:image', content: 'https://studio.avttr.my.id/og-image.jpg' },
        { property: 'og:image:secure_url', content: 'https://studio.avttr.my.id/og-image.jpg' },
        { property: 'og:image:width', content: '1200' },
        { property: 'og:image:height', content: '630' },
        { property: 'og:image:type', content: 'image/jpeg' },
        { property: 'og:image:alt', content: 'Avttr Studio — All-in-One Productivity Hub & Media Downloader' },
        // Twitter Cards
        ...
        { name: 'twitter:image', content: 'https://studio.avttr.my.id/og-image.jpg' },
      ],
      link: [
        { rel: 'image_src', href: 'https://studio.avttr.my.id/og-image.jpg' },
